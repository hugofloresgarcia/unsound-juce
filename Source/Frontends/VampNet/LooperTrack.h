...
public:
    ...
    void applyKnobState(const juce::var& state);
    ...
    double getLevelDb() const { return levelControl.getLevelValue(); }
    ...
    const juce::String& getTrackIdPrefix() const { return trackIdPrefix; }
